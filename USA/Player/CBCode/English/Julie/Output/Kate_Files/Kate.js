window.Kate_Dir = {
	"width":200, "height":250, "presenting":false, "fps":12, "blankfile":"blank.mp3", "modules":"rasterctl,bubble", "version":"5.4.5.0", "project":"Kate", "allowautoplay":"detect", "variables":"c.Text=\"0\";",
	"items":{
		"Scene1":{
			"type":"scene", "name":"Scene 1",
			"items":{
				"Char1":{"type":"character", "name":"Kate", "left":0, "top":67, "width":200, "height":160, "artwidth":250, "artheight":200, "mode":"replace"},
				"MsgChar1Idle":{
					"type":"message", "idle":true, "character":"Char1", "frames":16,
					"onframe":{
						"0":"c.load('Img1','FD1C42A1DFE10745A92DDEB0A5681550.png',237,106,106,1);c.load('Img2','A41E7E5D0E64388774FBDE7744006310.png',190,200,200,1);",
				...
				"Msg1":{"type":"message", "name":"Respond", "external":true, "url":"http://www.x-in-y.com/cs/cs.exe?template=Library%2FTemplates%2FServer%2FSpeech.xml&character=KateHead&addons=RW2HeadClothesPack1,RW2HeadClothesPack2,RW2HeadHairPack1,RW2HeadHairPack2,RW2HeadHairPack3,RW2HeadMedicalPack,RW2HeadPropPack1&voice=Neo%20Julie&size=200,160&autoactionlevel=2&customtop=blouse2&customhair=midlengthblonde&flashversion=8&actionscript=3&aiengine=programd&aimldatabase=SampleBot", "method":"get", "addvariables":"Text,AIMLUser,AIMLSession,AIMLTimezone", "character":"Char1"},
				...
				"Msg3":{"type":"message", "name":"Eyenormal", "character":"Char1", "frames":2, "datafile":"KateMsg3.js"}
			}
		}
	}
};
