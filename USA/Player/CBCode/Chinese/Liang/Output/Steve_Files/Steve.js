window.Steve_Dir = {
	"width":200, "height":250, "presenting":false, "fps":12, "blankfile":"blank.mp3", "modules":"rasterctl,bubble", "version":"5.4.5.0", "project":"Steve", "allowautoplay":"detect", "variables":"c.Text=\"0\";",
	"items":{
		"Scene1":{
			...
			"items":{
				...
				"MsgChar1Idle":{
					...
					"onframe":{
						"0":"c.load('Img1','2D63B3CFE5891B6559AA53F3E9B96CF9.png',250,105,105,1);c.load('Img2','F26A0831F2F51EAAAFE0DF9B6D2FEB13.png',219,200,200,1);",
				...
				"Msg1":{"type":"message", "name":"Respond", "external":true, "url":"http://www.x-in-y.com/cs/cs.exe?template=Library%2FTemplates%2FServer%2FSpeech.xml&character=SteveHead&addons=RM2HeadClothesPack1,RM2HeadClothesPack2,RM2HeadHairPack1,RM2HeadHairPack2,RM2HeadHairPack3,RM2HeadIndustryPack,RM2HeadPolicePack,RM2HeadPropPack1,RM2HeadSoldierPack&voice=Neo%20Liang&size=200,160&autoactionlevel=2&customtop=shirt1&customneck=tie1&customover=jacket1&customhair=stevecut&flashversion=8&actionscript=3&aiengine=programd&aimldatabase=SampleBot", "method":"get", "addvariables":"Text,AIMLUser,AIMLSession,AIMLTimezone", "character":"Char1"},
				...
				"Msg3":{"type":"message", "name":"Eyenormal", "character":"Char1", "frames":2, "datafile":"SteveMsg3.js"}
			}
		}
	}
};
