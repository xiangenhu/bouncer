window.Mia_Dir = {
	"width":200, "height":250, "presenting":false, "fps":12, "modules":"rasterctl,bubble", "version":"5.4.7.0", "project":"Mia", "allowautoplay":"detect", "variables":"c.Text=\"0\";",
	"items":{
		"Scene1":{
			...
			"items":{
				...
				"MsgChar1Idle":{
					...
					"onframe":{
						"0":"c.load('Img1','AA4A854F8B60CDB58032C9B793B9A743.png',237,106,106,1);c.load('Img2','04B3CBFA71C1115C7BC469DCBD37E4FD.png',190,200,200,1);",
				...
				"Msg1":{"type":"message", "name":"Respond", "external":true, "url":"http://localhost/cs/cs.exe?template=Library%2FTemplates%2FServer%2FSpeech.xml&character=PhotoFitWomanHead&addons=RW2HeadClothesPack1,RW2HeadClothesPack2,RW2HeadHairPack1,RW2HeadHairPack2,RW2HeadHairPack3,RW2HeadMedicalPack,RW2HeadPropPack1&voice=Neo%20Kate&size=200,160&autoactionlevel=2&customtop=blouse1&customhair=gelcutbrunette&customtop=blouse1&customhair=gelcutbrunette&customfaceref=Library%5CCharacters%5CPhotoFitWomanHead%5CPhotoFitWoman.fg&flashversion=8&actionscript=3&aiengine=programd&aimldatabase=SampleBot", "method":"get", "addvariables":"Text,AIMLUser,AIMLSession,AIMLTimezone", "character":"Char1"},
