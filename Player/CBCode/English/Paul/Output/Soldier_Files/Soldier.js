window.Soldier_Dir = {
	"width":200, "height":250, "presenting":false, "fps":12, "modules":"rasterctl,bubble", "version":"5.4.7.0", "project":"Soldier", "allowautoplay":"detect", "variables":"c.Text=\"0\";",
	"items":{
		"Scene1":{
			"type":"scene", "name":"Scene 1",
			"items":{
				"Char1":{"type":"character", "name":"PhotoFit Man", "left":0, "top":67, "width":200, "height":160, "artwidth":250, "artheight":200, "mode":"replace"},
				"MsgChar1Idle":{
					"type":"message", "idle":true, "character":"Char1", "frames":16,
					"onframe":{
						"0":"c.load('Img1','E81FC0A311EF4F697E20A761DC834CE6.png',250,105,105,1);c.load('Img2','D6938C19A42A847E9F03D651EFF7B586.png',219,200,200,1);",
				...
				"Msg1":{"type":"message", "name":"Respond", "external":true, "url":"https://www.x-in-y.com/cs/cs.exe?template=Library%2FTemplates%2FServer%2FSpeech.xml&character=PhotoFitManHead&addons=RM2HeadClothesPack1,RM2HeadClothesPack2,RM2HeadHairPack1,RM2HeadHairPack2,RM2HeadHairPack3,RM2HeadIndustryPack,RM2HeadPolicePack,RM2HeadPropPack1,RM2HeadSoldierPack&voice=Neo%20Paul&size=200,160&autoactionlevel=2&customfaceref=Library%5CCharacters%5CPhotoFitManHead%5CPhotoFitMan.fg&customtop=soldiershirt&customneck=policetie1&customover=none&customhair=messygray&customhead=soldierhelmet&customconformeareye=none&customtopcolor=44,38,43&flashversion=8&actionscript=3&aiengine=programd&aimldatabase=SampleBot", "method":"get", "addvariables":"Text,AIMLUser,AIMLSession,AIMLTimezone", "character":"Char1"},
				...
				"Msg3":{"type":"message", "name":"Eyenormal", "character":"Char1", "frames":2, "datafile":"SoldierMsg3.js"}
			}
		}
	}
};
