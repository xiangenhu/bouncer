window.PhotoFitMan_Dir = {
	"width":200, "height":250, "presenting":false, "fps":12, "modules":"rasterctl,bubble", "version":"5.4.7.0", "project":"PhotoFitMan", "allowautoplay":"detect", "variables":"c.Text=\"0\";",
	"items":{
		"Scene1":{
			...
			"items":{
				...
				"MsgChar1Idle":{
					...
					"onframe":{
						"0":"c.load('Img1','D87A3F88110B19C6761C0EC7F1AD6413.png',250,105,105,1);c.load('Img2','BB0BAED43AE41071E980B61D8D8994C2.png',219,200,200,1);",
				...
				"Msg1":{"type":"message", "name":"Respond", "external":true, "url":"http://www.x-in-y.com/cs/cs.exe?template=Library%2FTemplates%2FServer%2FSpeech.xml&character=PhotoFitManHead&addons=RM2HeadClothesPack1,RM2HeadClothesPack2,RM2HeadHairPack1,RM2HeadHairPack2,RM2HeadHairPack3,RM2HeadIndustryPack,RM2HeadPolicePack,RM2HeadPropPack1,RM2HeadSoldierPack&voice=Neo%20Paul&size=200,160&autoactionlevel=2&customfaceref=Library%5CCharacters%5CPhotoFitManHead%5CPhotoFitMan.fg&customtop=tshirt1&customhair=messygray&customhead=none&customtopcolor=44,38,43&flashversion=8&actionscript=3&aiengine=programd&aimldatabase=SampleBot", "method":"get", "addvariables":"Text,AIMLUser,AIMLSession,AIMLTimezone", "character":"Char1"},
				...
				"Msg3":{"type":"message", "name":"Eyenormal", "character":"Char1", "frames":2, "datafile":"PhotoFitManMsg3.js"}
			}
		}
	}
};
